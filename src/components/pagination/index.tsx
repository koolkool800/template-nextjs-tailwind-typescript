...
const Next: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
    {...props}
    width="24"
    height="25"
...
const Prev: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
    {...props}
    width="24"
    height="25"
...
export const Pagination = () => {
  return (
    <PaginationContainer>
      <Prev className="cursor-pointer w-[20px] h-[20px] hover:bg-custom-primaryColor hover:text-white rounded-full" />
      {arrPagination.map((item, index) => (
        <button
          className="cursor-pointer w-[20px] h-[20px] hover:bg-custom-primaryColor hover:text-white rounded-full lg:flex 
          justify-center items-center hidden md:block "
          key={index}
        >
          <p>{item}</p>
        </button>
      ...
      <Next className="w-[20px] cursor-pointer h-[20px] hover:bg-custom-primaryColor hover:text-white rounded-full" />
    </PaginationContainer>
  )
}
